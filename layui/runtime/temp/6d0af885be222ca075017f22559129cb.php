<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpstudy_pro\WWW\webserver\tp5.0\public/../application/admin\view\menu\index.html";i:1583243167;s:68:"D:\phpstudy_pro\WWW\webserver\tp5.0\application\admin\view\base.html";i:1583417065;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layui-body">
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li><a href="<?php echo url('addmenu'); ?>">添加菜单</a></li>
        </ul>
        <div class="layui-tab-content">
            <table class="layui-table">
                ...
                <tbody>
                <?php foreach($admin_level_list as $v): ?>
                <tr>
                    <td><?php echo $v['id']; ?></td>
                    <td><?php echo $v['sort']; ?></td>
                    <td><?php if($v['level'] != '1'): ?>|<?php for($i=1; $i<$v['level']; $i++){echo '---';} endif; ?><?php echo $v['title']; ?></td>
                    <td><?php echo $v['name']; ?></td>
                    <td><img src="/static/images/<?php if($v['status']==1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('auth_rule','id',<?php echo $v['id']; ?>,'status',this)"></td>
                    <td>
                        <a href="<?php echo url('addmenu',['pid'=>$v['id']]); ?>" class="layui-btn layui-btn-xs">添加子菜单</a>
